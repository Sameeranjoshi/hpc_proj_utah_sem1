// Use "gcc -O3 -fopenmp atbt_main.c atbt_par.c " to compile 
...
void atbt_seq(const double *__restrict__ A, const double *__restrict__ B, double *__restrict__ C, int Ni, int Nj, int Nk)
{
  int i, j, k;
