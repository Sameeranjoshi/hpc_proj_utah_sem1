...
declare -a arr=( "atbt_jik_unrolli_par.c" "atbt_par.c" "atbt_jki_j_par.c" "atbt_kij_i_par.c" "atbt_kji_j_par.c" "atbt_par.c" "atbt_ikj_tileij_par.c")
...
#   	gcc -O3 -fopenmp atb_main.c parallel_codes/$i -o exe/$filename.out
	gcc -O3 -fopenmp atbt_main.c parallel_codes/$i -o exe/$filename.out
